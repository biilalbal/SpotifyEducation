...
public class Methods {
    ...
    public void sendKeys(By by, String text){
        ...
        logger.info(by.toString() + " elementine " + text + " texti yazildi");
    }
    ...
    public void clickElementJs(By by){
        ...
        logger.info(by.toString() + " elemente js ile tiklandi");
    }
    ...
    public void doubleClick(By by){
        ...
        logger.info(element + " elementine double click islemi yapildi");
    }
}